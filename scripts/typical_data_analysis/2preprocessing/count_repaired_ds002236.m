...
%CCN.session = 'ses-T1';
CCN.func_pattern = 'sub*_task-VisRhyme*_run*_bold';
...
for i = 1:length(subjects)
    ...
    func_f = expand_path([func_p '/func/[func_pattern]/']);
...
dest_fname = strcat(preproc_dir, '/count_repaired_ds002236.csv');
